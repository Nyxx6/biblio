...
public class NewBook {
	...
	private void newbook() {
		if((isbn.isEnabled() && isbn.getText().isBlank()) || title.getText().isBlank() || pos.getText().isBlank() || list_auth.isEmpty()) {
...
auth.setFont(new Font("Arial Black", Font.PLAIN, 12));
...
add_sec.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent ev) {
		...
		JTextField t = new JTextField();
	     JOptionPane.showOptionDialog(frmAjouterOuvrage, new Object[] {"Entrer le nom d'édition:", t},
