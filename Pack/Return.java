...
public class Return {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(Return.class.getResource("/Pack/logo.png")));
		...
		panel.setBounds(134, 45, 399, 168);
		...
		r1 = new JRadioButton("Identifiant du document");
		...
		JButton view = new JButton("Retour");
		...
		view.setBorder(new MatteBorder(2, 2, 2, 2, (Color) Color.BLUE));
		view.setBounds(21, 224, 100, 23);
