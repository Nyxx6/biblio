...
public class Borrow {
	...
	private void newborrow() {
		...
		if(book.getId() > 0) {
			...
			String res = db.addBorrow_book(b);
			if( res == "ok")			
	...
	private void initialize() {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(Borrow.class.getResource("/Pack/logo.png")));
