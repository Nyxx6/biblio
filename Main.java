...
public class Main {
	...
	private void initialize() {
		...
		b1.setIcon(new ImageIcon(Main.class.getResource("/Pack/book-add-icon.png")));
		...
		b1.setBounds(46, 77, 174, 40);
		MainMenu.getContentPane().add(b1);
		
		JButton b2 = new JButton("Ajouter Membre");
		b2.setIcon(new ImageIcon(Main.class.getResource("/Pack/add-user-icon.png")));
		...
		b2.setBounds(444, 77, 174, 40);
		MainMenu.getContentPane().add(b2);
		
		JButton b4 = new JButton("Enregistrer Emprunt");
		b4.setIcon(new ImageIcon(Main.class.getResource("/Pack/date-add-icon.png")));
		...
		b4.setBounds(246, 77, 174, 40);
		MainMenu.getContentPane().add(b4);
		
		JButton b7 = new JButton("Recherche Document");
		b7.setIcon(new ImageIcon(Main.class.getResource("/Pack/books-icon.png")));
		...
		b7.setBounds(46, 160, 174, 40);
		MainMenu.getContentPane().add(b7);
		
		JButton b8 = new JButton("Rechercher Membre");
		b8.setIcon(new ImageIcon(Main.class.getResource("/Pack/Apps-system-users-icon (1).png")));
		...
		b8.setBounds(444, 160, 174, 40);
		MainMenu.getContentPane().add(b8);
		
		JLabel l = new JLabel("Gestion de la bibliothèque");
		l.setHorizontalAlignment(SwingConstants.CENTER);
		l.setFont(new Font("Arial Black", Font.PLAIN, 16));
		l.setBounds(211, 11, 239, 40);
		MainMenu.getContentPane().add(l);
		
		JButton b5 = new JButton("Vérifier Emprunt");
		b5.setIcon(new ImageIcon(Main.class.getResource("/Pack/date-icon.png")));
		...
		b5.setBounds(246, 160, 174, 40);
		MainMenu.getContentPane().add(b5);
		
		JButton lout = new JButton("Quitter");
		lout.setIcon(new ImageIcon(Main.class.getResource("/Pack/Logout-icon.png")));
		...
		MainMenu.setBounds(100, 100, 686, 275);
